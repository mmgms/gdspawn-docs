...
#. Enable/Disable alignment to surface normal.

#. Select which local axis of the scene should be aligned with the surface normal (useful for placing scenes on walls/ceilings).